...
typedef _AddMagnetWithResumeN = Int64 Function(
    Pointer<LtSessionOpaque>, Pointer<Utf8>, Pointer<Utf8>, Pointer<Uint8>, Int32);
typedef LtAddMagnetWithResume = int Function(
    Pointer<LtSessionOpaque>, Pointer<Utf8>, Pointer<Utf8>, Pointer<Uint8>, int);

typedef _AddTorrentFileWithResumeN = Int64 Function(
    Pointer<LtSessionOpaque>, Pointer<Utf8>, Pointer<Utf8>, Pointer<Uint8>, Int32);
typedef LtAddTorrentFileWithResume = int Function(
    Pointer<LtSessionOpaque>, Pointer<Utf8>, Pointer<Utf8>, Pointer<Uint8>, int);
...
class TorrentBridgeBindings {
  ...
  TorrentBridgeBindings(this._lib) {
    ...
    try {
      addTorrentFileWithResume = _lib.lookup<NativeFunction<_AddTorrentFileWithResumeN>>('lt_add_torrent_file_with_resume').asFunction<LtAddTorrentFileWithResume>();
    } catch (_) {
      addTorrentFileWithResume = null;
    }

    try {
      getResumeData = _lib.lookup<NativeFunction<_GetResumeDataN>>('lt_get_resume_data').asFunction<LtGetResumeData>();
    } catch (_) {
      getResumeData = null;
    }

    try {
      freeResumeData = _lib.lookup<NativeFunction<_FreeResumeDataN>>('lt_free_resume_data').asFunction<LtFreeResumeData>();
    } catch (_) {
      freeResumeData = null;
    }
  }
